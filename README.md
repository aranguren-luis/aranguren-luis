...
- **Playwright** – Automatización end‑to‑end.
- **Postman / Newman** – Validación automatizada de APIs.
- **JavaScript** – Scripting para pruebas personalizadas.
- **GitHub Actions** – Integración continua (ejecución automática en cada push).
- **SonarCloud** – Análisis estático de calidad de código.
- **Cucumber (BDD)** – Desarrollo guiado por comportamiento para alinear pruebas con requisitos de negocio.
...
- **Estrategias de QA**: planes de prueba, procedimientos estandarizados y métricas de calidad.
- **Ejecución y seguimiento**: documentación de resultados, informes de ejecución y análisis de tendencias.
- **Métricas clave**: P95, tasa de errores y throughput para evaluar rendimiento y fiabilidad.
- **Reportes reproducibles**: generación de informes en HTML, JSON y formatos avanzados, publicados en GitHub Pages.
...
- **Git** y **GitHub** – flujo de trabajo con ramas, pull requests y revisiones de código.
...
| **Automation** | **Languages** | **CI/CD & Quality** | **Project Management** |
|:---------------|:--------------|:--------------------|:-----------------------|
